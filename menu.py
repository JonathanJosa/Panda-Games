...
class menu:
    ...
    def gameLoop(self):
        ...
        img = [pygame.image.load('data/snake.jpg'), pygame.image.load('data/pingpong.png'), pygame.image.load('data/snake.jpg'), pygame.image.load('data/snake.jpg')]
        ...
        while self.ended:
            ...
            self.dis.blit(img[2], (660, 160), (0, 0, 180, 480))
