...
class tennis:
    ...
    def gameLoop(self):
        ...
        while True:
            ...
            pos_p1 += self.p1_change
            self.p1_change = 0

            ball_x += mov_x
            ball_y += mov_y

            if (200 < ball_x < 235 and self.p2_pos < ball_y < self.p2_pos+100):
                mov_x = -mov_x
            if (990 <= ball_x <= 1025 and pos_p1 < ball_y < pos_p1+100):
                mov_x = -mov_x
            ...
            pygame.draw.rect(self.dis, self.white, [975, self.p2_pos, 25, 100])
            pygame.draw.rect(self.dis, self.white, [200, pos_p1, 25, 100])
